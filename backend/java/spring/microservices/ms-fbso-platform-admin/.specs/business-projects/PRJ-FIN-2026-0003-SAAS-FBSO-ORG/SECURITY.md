...
- **Situação implementação:** Em Execução — Sprint 5 Frentes 0-1-2-3a concluídas ✅ (36/40, 90%). 26 endpoints REST. 4 features F04-01 a F04-04 entregues. 227 testes (0 failures). Correções de segurança aplicadas: URL injection ×2 (AuthService), IDOR resetPassword com Caffeine tokens, UUID validation em inputs.
