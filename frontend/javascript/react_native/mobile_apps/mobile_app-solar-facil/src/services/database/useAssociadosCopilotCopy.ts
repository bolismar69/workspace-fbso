...
export function useAssociadosCopilotCopy() {
  console.log("=== INICIO ========================================================================");
  ...
  console.log("=== INICIO ========================================================================");
  console.log("useAssociadosCopilot - Iniciando o hook useMovimentacoesCopilot...");

  console.info("useAssociadosCopilot - useDatabase() - Conexão com o banco de dados:", {
    isDatabaseConnected,
    dbInstance,
  });
