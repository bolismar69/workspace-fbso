...
* Objetivo de Negócio: Medir a eficiência da empresa em capturar os créditos de CBS e IBS nas compras do Lucro Real (Vinculado ao Épico 03 da Onda 2) [INDEX].
...
* Objetivo de Negócio: Monitorar se as instituições financeiras estão retendo valores a maior, especialmente nas operações com benefícios fiscais de Santana de Parnaíba (Vinculado ao Épico 02 da Onda 2) [INDEX].
...
* Objetivo de Negócio: Medir a consistência matemática do motor de cálculo corporativo no momento do faturamento (Vinculado ao Épico 01 da Onda 2) [INDEX].
...
* Objetivo de Negócio: Medir a saúde da base de dados do CRM para garantir que o princípio do destino seja aplicado sem travar a força de vendas (Vinculado ao Épico 01 da Onda 1) [INDEX].
...
* Objetivo de Negócio: Garantir que o cálculo centralizado e dinâmico do IVA Dual não degrade o tempo de resposta no e-commerce ou CRM (Vinculado ao Épico 02 da Onda 1) [INDEX].
