...
- **Fase:** F15 — Bloco C (Catálogo, Matriz, Stack, Specs & Milestones)
- **Versão:** 1.3
...
- **Bloco 0 — Baseline de Negócio:** [PRD-DEFINITION](./PROJECT-TECHNICAL-DEFINITIONS-PRD-DEFINITION.md) (F4) · [PRODUCT-BACKLOG-LIST](./PROJECT-TECHNICAL-DEFINITIONS-PRODUCT-BACKLOG-LIST.md) (F3)
...
- **Bloco B — Disciplinas Técnicas:** [ARCHITECTURE-DEFINITION](./PROJECT-TECHNICAL-DEFINITIONS-ARCHITECTURE-DEFINITION.md) (F7) · [SECURITY-DEFINITION](./PROJECT-TECHNICAL-DEFINITIONS-SECURITY-DEFINITION.md) (F8) · [DATA-ARCHITECTURE](./PROJECT-TECHNICAL-DEFINITIONS-DATA-ARCHITECTURE-DEFINITION.md) (F9) · [DEVOPS-SRE](./PROJECT-TECHNICAL-DEFINITIONS-DEVOPS-SRE-DEFINITION.md) (F10) · [TEST-STRATEGY](./PROJECT-TECHNICAL-DEFINITIONS-TEST-STRATEGY-DEFINITION.md) (F11) · [INFRA-CLOUD](./PROJECT-TECHNICAL-DEFINITIONS-INFRA-CLOUD-DEFINITION.md) (F12)
- **Bloco C — Upstream:** [SOLUTIONS-CATALOG](./PROJECT-TECHNICAL-DEFINITIONS-SOLUTIONS-CATALOG.md) (F13) · [SOLUTIONS-MATRIX](./PROJECT-TECHNICAL-DEFINITIONS-SOLUTIONS-MATRIX.md) (F14)
