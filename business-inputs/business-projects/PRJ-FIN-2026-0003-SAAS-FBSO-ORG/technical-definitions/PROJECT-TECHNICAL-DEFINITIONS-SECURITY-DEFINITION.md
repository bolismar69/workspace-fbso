...
- **Última Atualização:** 27 de Julho de 2026 (alinhamento com Bloco B v5.0)
- **Documento Mestre:** [GLOBAL-SECURITY.md](../../../.specs/security/GLOBAL-SECURITY.md) — este documento o especializa para o projeto
- **Fase:** F8 — Bloco B (Architecture & Security & Specialists) · **Disciplina:** Security Architect
...
- **Bloco B — Disciplinas Irmãs:** [ARCHITECTURE-DEFINITION](./PROJECT-TECHNICAL-DEFINITIONS-ARCHITECTURE-DEFINITION.md) (F7) · DATA-ARCH (F9 🆕) · DEVOPS-SRE (F10 🆕) · TEST-STRATEGY (F11 🆕) · INFRA-CLOUD (F12 🆕)
- **Documentos Complementares:** [TEAM-SKILLS-MAP](./PROJECT-TECHNICAL-DEFINITIONS-TEAM-SKILLS-MAP.md) (Discovery Team) · [TEAM-CAPACITY](./PROJECT-TECHNICAL-DEFINITIONS-TEAM-CAPACITY.md) (disponibilidade) · [ARCHITECTURE-DEFINITION](./PROJECT-TECHNICAL-DEFINITIONS-ARCHITECTURE-DEFINITION.md) · [STACK-MATRIX](./PROJECT-TECHNICAL-DEFINITIONS-SOLUTIONS-STACK-MATRIX.md)
