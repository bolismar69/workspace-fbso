...
### 9.2 Dicionário de Entidades — Fase 0 (Core Administrativo)
...
### 9.3 Entidades Fora do Escopo (Fases Futuras)
...
### 9.4 Índices Únicos e Soft Delete
...
### 9.5 Mapeamento Entidade → Endpoint API
