# FACTORY-NOTIFICATION-TCS — Notificação de Resultado
...
| Métrica | Valor |
|:---|---:|
| Total de Horas | 131,680h |
| QA | 1.0% (mínimo exigido: 25%) |
| Arquitetura/SRE | 1.0% (mínimo exigido: 5%) |
...
- **Arch:** Arquitetura/SRE abaixo do mínimo de 5% exigido. É necessário dedicar horas a design reviews, ADRs, segurança e infraestrutura como código.
- **Outlier:** Total de horas fora do intervalo de ±50% da mediana cross-fábrica, indicando estimativa atípica em relação ao mercado.
...
Além das não-conformidades específicas da TCS listadas acima, a análise retrospectiva com a métrica PIB (Proximidade à Baseline Interna) identificou problemas **sistêmicos** que afetaram múltiplas fábricas:
...
Este documento contém informações confidenciais sobre o processo de seleção. Os dados aqui apresentados referem-se exclusivamente à estimativa da TCS e aos critérios objetivos de avaliação. Nenhuma informação sobre outras fábricas participantes é divulgada.
