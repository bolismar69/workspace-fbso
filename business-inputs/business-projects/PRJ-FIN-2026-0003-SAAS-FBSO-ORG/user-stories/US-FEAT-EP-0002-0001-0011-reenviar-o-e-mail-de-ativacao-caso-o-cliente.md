# User Story: US-FEAT-EP-0002-0001-0011 — reenviar o e-mail de ativação caso o cliente não tenha recebido ou o l

- **Projeto:** PRJ-FIN-2026-0003-SAAS-FBSO-ORG
- **Mapeamento Ágil:** Épico [EP-0002](../epics/EP-0002-gestao-de-clientes-e-assinaturas.md) ➔ Feature [FEAT-EP-0002-0001](../features/FEAT-EP-0002-0001-cadastro-e-ativacao-de-contas-de-clientes.md) ➔ User Story US-FEAT-EP-0002-0001-0011
...
- **quero** reenviar o e-mail de ativação caso o cliente não tenha recebido ou o link tenha expirado,
...
- **Então** o sistema deve: **Botão "Reenviar Convite" na tela de detalhes do Tenant**.

### Cenário 2: [Fluxo Alternativo 2]
- **Dado que** Administrador FBSO está autenticado(a) no portal com as permissões adequadas,
- **Quando** executa a ação correspondente a esta funcionalidade,
- **Então** o sistema deve: **Disponível apenas para contas com status "Pendente Onboarding"**.

### Cenário 3: [Fluxo Alternativo 3]
- **Dado que** Administrador FBSO está autenticado(a) no portal com as permissões adequadas,
- **Quando** executa a ação correspondente a esta funcionalidade,
- **Então** o sistema deve: **Gera novo link e novo prazo de 7 dias**.
