# User Story: US-FEAT-EP-0002-0004-0021 — suspender a assinatura de um cliente, o que deve bloquear o acesso del

- **Projeto:** PRJ-FIN-2026-0003-SAAS-FBSO-ORG
- **Mapeamento Ágil:** Épico [EP-0002](../epics/EP-0002-gestao-de-clientes-e-assinaturas.md) ➔ Feature [FEAT-EP-0002-0004](../features/FEAT-EP-0002-0004-vinculacao-e-gestao-de-assinaturas.md) ➔ User Story US-FEAT-EP-0002-0004-0021
...
- **quero** suspender a assinatura de um cliente, o que deve bloquear o acesso dele aos módulos do plano,
...
- **Então** o sistema deve: **Suspensão da assinatura bloqueia acesso aos módulos em até 5 minutos**.

### Cenário 2: [Fluxo Alternativo 2]
- **Dado que** Administrador FBSO está autenticado(a) no portal com as permissões adequadas,
- **Quando** executa a ação correspondente a esta funcionalidade,
- **Então** o sistema deve: **Status da assinatura alterado para "Suspensa"**.

### Cenário 3: [Fluxo Alternativo 3]
- **Dado que** Administrador FBSO está autenticado(a) no portal com as permissões adequadas,
- **Quando** executa a ação correspondente a esta funcionalidade,
- **Então** o sistema deve: **Reativação da assinatura restaura acesso aos mesmos módulos**.
