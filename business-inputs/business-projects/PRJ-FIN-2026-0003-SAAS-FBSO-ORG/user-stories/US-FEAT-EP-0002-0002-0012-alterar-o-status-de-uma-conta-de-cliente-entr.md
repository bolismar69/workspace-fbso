# User Story: US-FEAT-EP-0002-0002-0012 — alterar o status de uma conta de cliente entre os estados: Pendente On

- **Projeto:** PRJ-FIN-2026-0003-SAAS-FBSO-ORG
- **Mapeamento Ágil:** Épico [EP-0002](../epics/EP-0002-gestao-de-clientes-e-assinaturas.md) ➔ Feature [FEAT-EP-0002-0002](../features/FEAT-EP-0002-0002-gestao-de-status-do-tenant.md) ➔ User Story US-FEAT-EP-0002-0002-0012
...
- **quero** alterar o status de uma conta de cliente entre os estados: Pendente Onboarding, Ativo, Suspenso, Inativo para refletir a situação real da conta,
...
- **Então** o sistema deve: **Seletor de status na tela de detalhes do Tenant**.

### Cenário 2: [Fluxo Alternativo 2]
- **Dado que** Administrador FBSO está autenticado(a) no portal com as permissões adequadas,
- **Quando** executa a ação correspondente a esta funcionalidade,
- **Então** o sistema deve: **Transições permitidas seguem regra de negócio RN-FEAT-EP-0002-0002-0001**.

### Cenário 3: [Fluxo Alternativo 3]
- **Dado que** Administrador FBSO está autenticado(a) no portal com as permissões adequadas,
- **Quando** executa a ação correspondente a esta funcionalidade,
- **Então** o sistema deve: **Ao alterar para Suspenso, campo de motivo é obrigatório**.
