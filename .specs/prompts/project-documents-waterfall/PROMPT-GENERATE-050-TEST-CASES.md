...
| Parâmetro | Descrição |
|---|---|
| `DOC_PATH` | Caminho completo onde o arquivo será criado (formato: `050-TEST-CASES-{PROJECT_ID_NAME}.md`) |
...
| `UPSTREAM_DOCS` | Lista: `[001-PROJECT-CHARTER, 010-FRD, 020-SRS, 045-TEST-PLAN]` |
...
| **Documentos Base** | 001-PROJECT-CHARTER, 010-FRD, 020-SRS, 045-TEST-PLAN |
