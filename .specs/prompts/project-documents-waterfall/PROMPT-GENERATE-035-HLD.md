...
| Parâmetro | Descrição |
|---|---|
| `DOC_PATH` | Caminho completo onde o arquivo será criado (formato: `035-HLD-{PROJECT_ID_NAME}.md`) |
...
| `UPSTREAM_DOCS` | Lista: `[001-PROJECT-CHARTER, 030-SAD]` |
...
| **Documentos Base** | 001-PROJECT-CHARTER, 030-SAD |
