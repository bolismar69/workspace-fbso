# PROMPT: PORTÃO DE VALIDAÇÃO DE TERMO DE ACEITE (SIGN-OFF)
...
2. **Deliverables:** Todos os deliverables do Charter listados com status de aceite?
3. **Quality Gates:** Quality gate results do Relatório de Qualidade referenciados?
4. **Punch List:** Punch list documentada (vazia ou com itens pendentes)?
5. **Aceite Formal:** Declaração formal de aceite e tabela de assinaturas presentes?
