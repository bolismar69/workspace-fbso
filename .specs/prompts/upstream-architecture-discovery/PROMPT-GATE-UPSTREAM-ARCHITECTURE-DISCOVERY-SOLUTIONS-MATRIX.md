# PROMPT-GATE-UPSTREAM-ARCHITECTURE-DISCOVERY-SOLUTIONS-MATRIX

## Contexto

Este prompt implementa o **GATE do SOLUTIONS-MATRIX Discovery-Level** — Fase do Bloco C/D do Upstream Architecture Discovery.
...
**Inputs upstream:**
1. `{UPSTREAM_DISCOVERY_PATH}/DISCOVERY-LEVEL-SOLUTIONS-MATRIX.md` — artefato auditado (F9)
...
Validar que o artefato auditado `{UPSTREAM_DISCOVERY_PATH}/DISCOVERY-LEVEL-SOLUTIONS-MATRIX.md` existe.
...
🤖 *Upstream Architecture Discovery — SOLUTIONS-MATRIX GATE*
