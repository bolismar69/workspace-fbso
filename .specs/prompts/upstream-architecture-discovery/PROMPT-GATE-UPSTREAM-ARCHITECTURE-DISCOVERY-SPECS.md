# PROMPT-GATE-UPSTREAM-ARCHITECTURE-DISCOVERY-SPECS

## Contexto

Este prompt implementa o **GATE do SPECS Discovery-Level** — Fase do Bloco C/D do Upstream Architecture Discovery.
...
**Inputs upstream:**
1. `{UPSTREAM_DISCOVERY_PATH}/DISCOVERY-LEVEL-SPECS.md` — artefato auditado (F10)
...
Validar que o artefato auditado `{UPSTREAM_DISCOVERY_PATH}/DISCOVERY-LEVEL-SPECS.md` existe.
...
🤖 *Upstream Architecture Discovery — SPECS GATE*
