...
**Inputs upstream:** `UPSTREAM-ARCHITECTURE-DISCOVERY-ARCHITECTURE-DEFINITION.md` (Fase 7) + `UPSTREAM-ARCHITECTURE-DISCOVERY-PRD-DEFINITION.md` (Fase 4) + `GLOBAL-SECURITY.md` + `UPSTREAM-ARCHITECTURE-DISCOVERY-SOLUTIONS-CATALOG.md` (Fase 2).
...
Gerar `{TECHNICAL_DEFINITIONS_PATH}/UPSTREAM-ARCHITECTURE-DISCOVERY-SECURITY-DEFINITION.md` com:
