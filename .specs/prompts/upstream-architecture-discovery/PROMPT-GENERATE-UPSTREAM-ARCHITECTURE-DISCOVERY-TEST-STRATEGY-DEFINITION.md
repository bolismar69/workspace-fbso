...
**Inputs upstream:** `UPSTREAM-ARCHITECTURE-DISCOVERY-ARCHITECTURE-DEFINITION.md` (Fase 7) + `UPSTREAM-ARCHITECTURE-DISCOVERY-SECURITY-DEFINITION.md` (Fase 8) + `UPSTREAM-ARCHITECTURE-DISCOVERY-DEVOPS-SRE-DEFINITION.md` (Fase 10) + `UPSTREAM-ARCHITECTURE-DISCOVERY-INFRA-CLOUD-DEFINITION.md` (Fase 12 — referência para ambientes de teste).
...
Gerar `{TECHNICAL_DEFINITIONS_PATH}/UPSTREAM-ARCHITECTURE-DISCOVERY-TEST-STRATEGY-DEFINITION.md` com:
