# PROMPT-GATE-UPSTREAM-ARCHITECTURE-DISCOVERY-ROM-ESTIMATE

## Contexto

Este prompt implementa o **GATE do ROM-ESTIMATE Discovery-Level** — Fase do Bloco C/D do Upstream Architecture Discovery.
