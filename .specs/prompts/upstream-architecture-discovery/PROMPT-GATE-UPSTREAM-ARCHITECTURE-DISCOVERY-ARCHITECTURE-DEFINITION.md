...
Este prompt implementa o **Gate de Validação da Definição de Arquitetura** para o artefato `UPSTREAM-ARCHITECTURE-DISCOVERY-ARCHITECTURE-DEFINITION.md`. Verifica se a arquitetura do projeto está completa, consistente e cobre todas as soluções do catálogo.
...
**Arquivos gerados pelo GENERATE:** `UPSTREAM-ARCHITECTURE-DISCOVERY-ARCHITECTURE-DEFINITION.md`
...
Ler `UPSTREAM-ARCHITECTURE-DISCOVERY-ARCHITECTURE-DEFINITION.md`, Catálogo de Soluções, PRD Definition, ADRs globais.
