...
**Inputs upstream:** `UPSTREAM-ARCHITECTURE-DISCOVERY-PRD-DEFINITION.md` (Fase 4) + `UPSTREAM-ARCHITECTURE-DISCOVERY-TEAM-SKILLS-MAP.md` (Fase 5) + `UPSTREAM-ARCHITECTURE-DISCOVERY-ARCHITECTURE-DEFINITION.md` (Fase 7) + `UPSTREAM-ARCHITECTURE-DISCOVERY-SECURITY-DEFINITION.md` (Fase 8) + `{ARCHITECTURE_GLOBAL}` (ADRs, blueprints, data standards).
...
Gerar `{TECHNICAL_DEFINITIONS_PATH}/UPSTREAM-ARCHITECTURE-DISCOVERY-DATA-ARCHITECTURE-DEFINITION.md` com:
