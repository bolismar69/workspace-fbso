# PROMPT-GENERATE-PROJECT-TECHNICAL-DEFINITIONS-DEVOPS-SRE-DEFINITION

## Contexto

Este prompt gera o artefato `PROJECT-TECHNICAL-DEFINITIONS-DEVOPS-SRE-DEFINITION.md` — a **definição de DevOps e SRE do projeto** que especifica CI/CD, IaC, observabilidade, SLOs, runbooks e gestão de ambientes. Este documento é a referência operacional para toda a esteira de deploy e operação do projeto.
...
**Inputs upstream:** `PROJECT-TECHNICAL-DEFINITIONS-ARCHITECTURE-DEFINITION.md` (Fase 7) + `PROJECT-TECHNICAL-DEFINITIONS-SECURITY-DEFINITION.md` (Fase 8) + `PROJECT-TECHNICAL-DEFINITIONS-DATA-ARCHITECTURE-DEFINITION.md` (Fase 9) + `{ARCHITECTURE_GLOBAL}` (blueprints, ADRs).
...
Gerar `{TECHNICAL_DEFINITIONS_PATH}/PROJECT-TECHNICAL-DEFINITIONS-DEVOPS-SRE-DEFINITION.md` com:
