# PROMPT-GENERATE-570-MILESTONES (F17)

## Contexto

Este prompt gera o artefato `570-MILESTONES.md` — o **roadmap de milestones técnicos** do projeto alinhado com USER-STORIES, FEATURES, EPICS, BRD e PROJECT-CHARTER. Define quando cada solução será construída, em que ordem e com quais dependências.

**Inputs upstream (Bloco C — F17):** Este artefato é o último do Bloco C e consolida os insumos de todos os blocos anteriores:
- **F16 (SPECS-DEFINITION):** `560-SPECS-DEFINITION.md` — consolidação técnica enxuta (principal insumo)
- **Bloco 0 (Product Def & Backlog & PRD):** `440-PRD-DEFINITION.md` (F4) + `430-PRODUCT-BACKLOG-LIST.md` (F3)
...
Gerar `{TECHNICAL_DEFINITIONS_PATH}/570-MILESTONES.md` com:
