# PROMPT-FIX-420-DOR-ASSESSMENT

## Contexto

Este prompt é acionado quando o `PROMPT-GATE-420-DOR-ASSESSMENT.md` emite `[NÃO COMPLIANCE]` para o artefato `420-DOR-ASSESSMENT.md`.
...
Ler `420-DOR-ASSESSMENT.md` (artefato a corrigir), `410-INTAKE-LOG.md` (referência de itens) e o **Relatório de Auditoria** emitido pelo gate (relatório inline com os IDs de conflito e respostas do humano).
