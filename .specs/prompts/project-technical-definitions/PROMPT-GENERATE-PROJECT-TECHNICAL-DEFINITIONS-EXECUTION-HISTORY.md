...
Este prompt gerencia o artefato `PROJECT-TECHNICAL-DEFINITIONS-EXECUTION-HISTORY.md` — o **dashboard de controle** que registra o estado de CADA documento gerado em TODAS as 19 fases + artefatos migrados do roadmap. Diferente dos outros artefatos, este NÃO tem gate/fix próprios — ele é **atualizado incrementalmente** após cada fase ser concluída.
...
| SPRINT-BACKLOG.md | D | F18 | technical-discovery/SPRINT-BACKLOG.md | PENDENTE | — | — | — | — |
| DISCOVERY TÉCNICO (sprint-NNN/) | D | F19 | technical-discovery/sprint-NNN/ | PENDENTE | — | — | — | — |
