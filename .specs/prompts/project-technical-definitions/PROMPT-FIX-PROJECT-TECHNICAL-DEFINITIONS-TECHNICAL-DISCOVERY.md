# PROMPT-FIX-PROJECT-TECHNICAL-DEFINITIONS-TECHNICAL-DISCOVERY

## Contexto

Este prompt é acionado quando o gate reprova os contratos de uma sprint em `technical-discovery/sprint-NNN/`. O agente corretor aplica correções cirúrgicas com base no relatório inline do gate. **Nunca reescreve os arquivos do zero. Modifique estritamente as seções, tabelas ou linhas apontadas como Não Compliance nos contratos afetados.**
