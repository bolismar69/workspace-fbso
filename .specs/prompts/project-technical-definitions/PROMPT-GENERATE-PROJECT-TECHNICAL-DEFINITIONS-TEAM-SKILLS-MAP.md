...
Gerar `{TECHNICAL_DEFINITIONS_PATH}/PROJECT-TECHNICAL-DEFINITIONS-TEAM-SKILLS-MAP.md` seguindo o modelo da seção "Modelo do Arquivo" abaixo, preenchendo:
...
O arquivo `PROJECT-TECHNICAL-DEFINITIONS-TEAM-SKILLS-MAP.md` deve seguir a estrutura abaixo:

```markdown
# PROJECT-TECHNICAL-DEFINITIONS-TEAM-SKILLS-MAP — Matriz de Skills do Time Técnico
...
Este documento apresenta a **matriz de competências técnicas** do time executor do projeto — o **Discovery Team** responsável pela fase de Upstream Architecture. Enquanto o [TEAM-CAPACITY](./PROJECT-TECHNICAL-DEFINITIONS-TEAM-CAPACITY.md) responde **QUEM** está disponível e **quantas horas/dia**, este documento foca em **O QUE** cada perfil sabe fazer e seu **nível de proficiência**.
...
| [PRD-DEFINITION.md](./PROJECT-TECHNICAL-DEFINITIONS-PRD-DEFINITION.md) | PRD de Negócio congelado (F4 — Bloco 0) |
