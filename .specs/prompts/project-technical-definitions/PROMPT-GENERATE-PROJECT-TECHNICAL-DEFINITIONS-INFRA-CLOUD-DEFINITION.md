# PROMPT-GENERATE-PROJECT-TECHNICAL-DEFINITIONS-INFRA-CLOUD-DEFINITION

## Contexto

Este prompt gera o artefato `PROJECT-TECHNICAL-DEFINITIONS-INFRA-CLOUD-DEFINITION.md` — a **definição de infraestrutura cloud/on-premise do projeto** que especifica topologia, compute, networking, storage, disaster recovery, dimensionamento e custos. Este documento é a referência técnica para toda a infraestrutura que suporta as soluções do projeto.
...
**Inputs upstream:** `PROJECT-TECHNICAL-DEFINITIONS-ARCHITECTURE-DEFINITION.md` (Fase 7) + `PROJECT-TECHNICAL-DEFINITIONS-SECURITY-DEFINITION.md` (Fase 8) + `PROJECT-TECHNICAL-DEFINITIONS-DATA-ARCHITECTURE-DEFINITION.md` (Fase 9) + `PROJECT-TECHNICAL-DEFINITIONS-DEVOPS-SRE-DEFINITION.md` (Fase 10).
...
Gerar `{TECHNICAL_DEFINITIONS_PATH}/PROJECT-TECHNICAL-DEFINITIONS-INFRA-CLOUD-DEFINITION.md` com:
