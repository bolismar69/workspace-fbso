# PROMPT-GENERATE-500-DEVOPS-SRE-DEFINITION

## Contexto

Este prompt gera o artefato `500-DEVOPS-SRE-DEFINITION.md` — a **definição de DevOps e SRE do projeto** que especifica CI/CD, IaC, observabilidade, SLOs, runbooks e gestão de ambientes. Este documento é a referência operacional para toda a esteira de deploy e operação do projeto.
...
**Inputs upstream:** `470-ARCHITECTURE-DEFINITION.md` (Fase 7) + `480-SECURITY-DEFINITION.md` (Fase 8) + `490-DATA-ARCHITECTURE-DEFINITION.md` (Fase 9) + `{ARCHITECTURE_GLOBAL}` (blueprints, ADRs).
...
Gerar `{TECHNICAL_DEFINITIONS_PATH}/500-DEVOPS-SRE-DEFINITION.md` com:
