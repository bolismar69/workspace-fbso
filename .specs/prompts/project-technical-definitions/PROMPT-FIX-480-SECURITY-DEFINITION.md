# PROMPT-FIX-480-SECURITY-DEFINITION

## Contexto

Este prompt é acionado quando o gate reprova `480-SECURITY-DEFINITION.md`. O agente corretor aplica correções cirúrgicas com base no relatório inline do gate, com atenção especial às Regras de Ouro (P0 — inegociáveis). **Nunca reescreve o documento do zero. Modifique estritamente as seções, tabelas ou linhas apontadas como Não Compliance.**
