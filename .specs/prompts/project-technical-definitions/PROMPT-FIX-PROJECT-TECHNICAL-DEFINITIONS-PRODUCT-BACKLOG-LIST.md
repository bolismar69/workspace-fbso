# PROMPT-FIX-PROJECT-TECHNICAL-DEFINITIONS-PRODUCT-BACKLOG-LIST

## Contexto

Este prompt é acionado quando o `PROMPT-GATE-PROJECT-TECHNICAL-DEFINITIONS-PRODUCT-BACKLOG-LIST.md` emite `[NÃO COMPLIANCE]` para o artefato `PROJECT-TECHNICAL-DEFINITIONS-PRODUCT-BACKLOG-LIST.md`.
...
Ler `PROJECT-TECHNICAL-DEFINITIONS-PRODUCT-BACKLOG-LIST.md` (artefato a corrigir), `PROJECT-TECHNICAL-DEFINITIONS-DOR-ASSESSMENT.md` (referência de itens aprovados), `PROJECT-TECHNICAL-DEFINITIONS-INTAKE-LOG.md` (referência de lotes) e o **Relatório de Auditoria** emitido pelo gate (relatório inline com os IDs de conflito e respostas do humano).
