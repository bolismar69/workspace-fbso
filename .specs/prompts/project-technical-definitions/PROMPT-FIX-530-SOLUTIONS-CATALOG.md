# PROMPT-FIX-530-SOLUTIONS-CATALOG (F13)

## Contexto

Este prompt é acionado quando o gate (F13) reprova `530-SOLUTIONS-CATALOG.md`. O agente corretor aplica correções cirúrgicas com base no relatório inline do gate, incluindo validação cruzada com as 6 disciplinas do Bloco B, preservando seções aprovadas. **Nunca reescreve o documento do zero. Modifique estritamente as seções, tabelas ou linhas apontadas como Não Compliance.**
