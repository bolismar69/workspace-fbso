# PROMPT-GENERATE-410-INTAKE-LOG

## Contexto

Este prompt gera o artefato `410-INTAKE-LOG.md` 🆕 — o **registro de lotes de ingestão de requisitos** do Negócio para a TI. Documenta cada onda/lote de requisitos recebido, sua origem, data, responsável e escopo.
...
Gerar `{TECHNICAL_DEFINITIONS_PATH}/410-INTAKE-LOG.md` com:
