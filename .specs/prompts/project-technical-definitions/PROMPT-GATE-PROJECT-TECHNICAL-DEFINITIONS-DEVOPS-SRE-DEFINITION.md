# PROMPT-GATE-PROJECT-TECHNICAL-DEFINITIONS-DEVOPS-SRE-DEFINITION

## Contexto

Este prompt implementa o **Gate de Validação da Definição de DevOps e SRE** para o artefato `PROJECT-TECHNICAL-DEFINITIONS-DEVOPS-SRE-DEFINITION.md`. Verifica se a estratégia de operações do projeto está completa, cobre CI/CD, IaC, observabilidade, SLOs e runbooks, e está alinhada com a arquitetura e segurança.
...
**Arquivos gerados pelo GENERATE:** `PROJECT-TECHNICAL-DEFINITIONS-DEVOPS-SRE-DEFINITION.md`
...
Ler `PROJECT-TECHNICAL-DEFINITIONS-DEVOPS-SRE-DEFINITION.md`, Architecture Definition (F7), Security Definition (F8), Data Architecture (F9), ADRs globais.
...
*(Instrução: O processo pausa aqui. Assim que o humano responder, injete este relatório + respostas no PROMPT-FIX-PROJECT-TECHNICAL-DEFINITIONS-DEVOPS-SRE-DEFINITION.md)*
...
- **DOCUMENTO:** `PROJECT-TECHNICAL-DEFINITIONS-DEVOPS-SRE-DEFINITION.md` gerado conforme Architecture Definition, Security Definition e Data Architecture.
