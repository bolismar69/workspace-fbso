# PROMPT-GENERATE-PROJECT-TECHNICAL-DEFINITIONS-TEST-STRATEGY-DEFINITION

## Contexto

Este prompt gera o artefato `PROJECT-TECHNICAL-DEFINITIONS-TEST-STRATEGY-DEFINITION.md` — a **definição de estratégia de testes do projeto** que especifica a pirâmide de testes, automação, performance, segurança, ambientes e quality gates. Este documento é a referência normativa para toda a atividade de testes no projeto.
...
**Inputs upstream:** `PROJECT-TECHNICAL-DEFINITIONS-ARCHITECTURE-DEFINITION.md` (Fase 7) + `PROJECT-TECHNICAL-DEFINITIONS-SECURITY-DEFINITION.md` (Fase 8) + `PROJECT-TECHNICAL-DEFINITIONS-DEVOPS-SRE-DEFINITION.md` (Fase 10) + `PROJECT-TECHNICAL-DEFINITIONS-INFRA-CLOUD-DEFINITION.md` (Fase 12 — referência para ambientes de teste).
...
Gerar `{TECHNICAL_DEFINITIONS_PATH}/PROJECT-TECHNICAL-DEFINITIONS-TEST-STRATEGY-DEFINITION.md` com:
