# PROMPT-GATE-PROJECT-TECHNICAL-DEFINITIONS-SPECS-DEFINITION (F16)

## Contexto

Este prompt implementa o **Gate de Validação da Consolidação Técnica (F16)** para o artefato `PROJECT-TECHNICAL-DEFINITIONS-SPECS-DEFINITION.md`. Verifica se a consolidação enxuta referencia 100% dos artefatos dos blocos anteriores, se os links markdown são válidos e se não há duplicação de conteúdo.
...
**Arquivos gerados pelo GENERATE:** `PROJECT-TECHNICAL-DEFINITIONS-SPECS-DEFINITION.md`
...
Ler `PROJECT-TECHNICAL-DEFINITIONS-SPECS-DEFINITION.md` e TODOS os artefatos referenciados (Blocos 0, A, B, C) para verificar existência e consistência das referências.
...
*(Instrução: O processo pausa aqui. Assim que o humano responder, injete este relatório + respostas no PROMPT-FIX-PROJECT-TECHNICAL-DEFINITIONS-SPECS-DEFINITION.md)*
...
- **DOCUMENTO:** `PROJECT-TECHNICAL-DEFINITIONS-SPECS-DEFINITION.md` gerado como consolidação técnica enxuta.
