# PROMPT-GENERATE-540-SOLUTIONS-MATRIX

## Contexto

Este prompt gera o artefato `540-SOLUTIONS-MATRIX.md` — a **matriz-mestra** que consolida todas as definições anteriores em uma tabela única: solução → responsável → repositório → stack → perfis → status.
...
- **F13 (Bloco C):** `530-SOLUTIONS-CATALOG.md` — catálogo de soluções (primeiro artefato do Bloco C)
...
Gerar `{TECHNICAL_DEFINITIONS_PATH}/540-SOLUTIONS-MATRIX.md` com:
