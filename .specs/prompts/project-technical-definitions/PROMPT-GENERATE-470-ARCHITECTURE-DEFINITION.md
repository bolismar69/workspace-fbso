# PROMPT-GENERATE-470-ARCHITECTURE-DEFINITION

## Contexto

Este prompt gera o artefato `470-ARCHITECTURE-DEFINITION.md` — a **definição de arquitetura do projeto** que especifica como todas as soluções técnicas se integram. Este documento **absorve e substitui** o INTEGRATION-MAP.md existente (criado ad-hoc) e define o "C4 Level 1 e 2 do projeto inteiro".

**Inputs upstream:** `530-SOLUTIONS-CATALOG.md` (Fase 2) + `440-PRD-DEFINITION.md` (Fase 4) + `architecture/` (ADRs, blueprints, data standards globais) + TECHNICAL-PLAN.md (referência).
...
Gerar `{TECHNICAL_DEFINITIONS_PATH}/470-ARCHITECTURE-DEFINITION.md` com:
