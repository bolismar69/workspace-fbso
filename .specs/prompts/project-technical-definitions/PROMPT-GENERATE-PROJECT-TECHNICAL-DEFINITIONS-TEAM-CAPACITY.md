# PROMPT-GENERATE-PROJECT-TECHNICAL-DEFINITIONS-TEAM-CAPACITY

## Contexto

Este prompt gera o artefato `PROJECT-TECHNICAL-DEFINITIONS-TEAM-CAPACITY.md` — a **tabela de capacidade do time técnico** que registra os profissionais que efetivamente executarão as tarefas de implementação das soluções técnicas do projeto (Bloco A — Fase 6).

Diferente do `PROJECT-TECHNICAL-DEFINITIONS-TEAM-SKILLS-MAP.md` (Fase 5 — que foca em O QUE cada perfil sabe fazer — skills e níveis de proficiência), este documento foca em QUEM está disponível, quantas horas/dia e por qual período.
...
>
> O arquivo `PROJECT-TECHNICAL-DEFINITIONS-TEAM-CAPACITY.md` será criado para registrar os integrantes do time técnico e sua capacidade de trabalho.
>
...
Gerar `{TECHNICAL_DEFINITIONS_PATH}/PROJECT-TECHNICAL-DEFINITIONS-TEAM-CAPACITY.md` com a estrutura abaixo.
