...
Este prompt é acionado quando o `PROMPT-GATE-PROJECT-TECHNICAL-DEFINITIONS-INTAKE-LOG.md` emite `[NÃO COMPLIANCE]` para o artefato `PROJECT-TECHNICAL-DEFINITIONS-INTAKE-LOG.md`.
...
Ler `PROJECT-TECHNICAL-DEFINITIONS-INTAKE-LOG.md` (artefato a corrigir), documentos de negócio (Charter, BRD, Epics, Features, User Stories) como referência, e o **Relatório de Auditoria** emitido pelo gate (relatório inline com os IDs de conflito e respostas do humano).
