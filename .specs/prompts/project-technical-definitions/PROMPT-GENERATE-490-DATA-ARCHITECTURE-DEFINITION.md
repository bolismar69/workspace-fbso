# PROMPT-GENERATE-490-DATA-ARCHITECTURE-DEFINITION

## Contexto

Este prompt gera o artefato `490-DATA-ARCHITECTURE-DEFINITION.md` — a **definição de arquitetura de dados do projeto** que especifica modelagem, armazenamento, pipelines, integrações e governança de dados. Este documento é a referência técnica para todas as decisões relacionadas a dados no projeto.
...
**Inputs upstream:** `440-PRD-DEFINITION.md` (Fase 4) + `450-TEAM-SKILLS-MAP.md` (Fase 5) + `470-ARCHITECTURE-DEFINITION.md` (Fase 7) + `480-SECURITY-DEFINITION.md` (Fase 8) + `{ARCHITECTURE_GLOBAL}` (ADRs, blueprints, data standards).
...
Gerar `{TECHNICAL_DEFINITIONS_PATH}/490-DATA-ARCHITECTURE-DEFINITION.md` com:
