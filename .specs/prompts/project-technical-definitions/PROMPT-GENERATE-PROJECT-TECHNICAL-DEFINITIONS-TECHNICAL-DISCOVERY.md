# PROMPT-GENERATE-PROJECT-TECHNICAL-DEFINITIONS-TECHNICAL-DISCOVERY

## Contexto

Este prompt gera os **contratos técnicos por sprint** dentro do diretório `technical-discovery/sprint-NNN/`. Este é um prompt **iterativo** — executa uma vez por sprint desejada, gerando 5 arquivos de contrato por sprint que detalham os acordos técnicos entre as disciplinas de API, Dados, Segurança e SRE, além da definição de incrementos retroativos.
...
- **SPRINT-BACKLOG.md (F18):** Tarefas T-NNN da sprint atual, US vinculadas e contratos
...
- **Versão:** 1.0
- **Artefato Base:** [ARCHITECTURE-DEFINITION.md](../../PROJECT-TECHNICAL-DEFINITIONS-ARCHITECTURE-DEFINITION.md)
- **Specs Base:** [SPECS-DEFINITION.md](../../PROJECT-TECHNICAL-DEFINITIONS-SPECS-DEFINITION.md)
...
- **Sprint:** {SPRINT_NUMBER}
- **Versão:** 1.0
- **Artefato Base:** [DATA-ARCHITECTURE-DEFINITION.md](../../PROJECT-TECHNICAL-DEFINITIONS-DATA-ARCHITECTURE-DEFINITION.md)
- **Specs Base:** [SPECS-DEFINITION.md](../../PROJECT-TECHNICAL-DEFINITIONS-SPECS-DEFINITION.md)
...
- **Sprint:** {SPRINT_NUMBER}
- **Versão:** 1.0
- **Artefato Base:** [SECURITY-DEFINITION.md](../../PROJECT-TECHNICAL-DEFINITIONS-SECURITY-DEFINITION.md)
- **Specs Base:** [SPECS-DEFINITION.md](../../PROJECT-TECHNICAL-DEFINITIONS-SPECS-DEFINITION.md)
...
- **Sprint:** {SPRINT_NUMBER}
- **Versão:** 1.0
- **Artefato Base:** [DEVOPS-SRE-DEFINITION.md](../../PROJECT-TECHNICAL-DEFINITIONS-DEVOPS-SRE-DEFINITION.md)
