# PROMPT-FIX-450-TEAM-SKILLS-MAP

## Contexto

Este prompt é acionado quando o `PROMPT-GATE-450-TEAM-SKILLS-MAP.md` emite `[NÃO COMPLIANCE]` para o artefato `450-TEAM-SKILLS-MAP.md` (Bloco A — Fase 5).
...
Ler `450-TEAM-SKILLS-MAP.md` (artefato a corrigir), `460-TEAM-CAPACITY.md` (referência) e o **Relatório de Auditoria** emitido pelo gate (relatório inline com os IDs de conflito e respostas do humano).
