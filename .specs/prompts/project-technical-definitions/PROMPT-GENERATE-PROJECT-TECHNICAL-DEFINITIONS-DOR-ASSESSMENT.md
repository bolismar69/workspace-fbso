# PROMPT-GENERATE-PROJECT-TECHNICAL-DEFINITIONS-DOR-ASSESSMENT

## Contexto

Este prompt gera o artefato `PROJECT-TECHNICAL-DEFINITIONS-DOR-ASSESSMENT.md` 🆕 — a **avaliação de Definition of Ready (DoR)** dos requisitos recebidos. Aplica um checklist formal a cada item do INTAKE-LOG para determinar se está suficientemente refinado para seguir para o backlog técnico.
...
Gerar `{TECHNICAL_DEFINITIONS_PATH}/PROJECT-TECHNICAL-DEFINITIONS-DOR-ASSESSMENT.md` com:
