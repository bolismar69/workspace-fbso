...
- **F13 (Bloco C):** `PROJECT-TECHNICAL-DEFINITIONS-SOLUTIONS-CATALOG.md` — catálogo de soluções
- **F14 (Bloco C):** `PROJECT-TECHNICAL-DEFINITIONS-SOLUTIONS-MATRIX.md` — matriz solução×stack×owner
