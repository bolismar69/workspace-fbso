# PROMPT-GATE-PROJECT-TECHNICAL-DEFINITIONS-DATA-ARCHITECTURE-DEFINITION

## Contexto

Este prompt implementa o **Gate de Validação da Definição de Arquitetura de Dados** para o artefato `PROJECT-TECHNICAL-DEFINITIONS-DATA-ARCHITECTURE-DEFINITION.md`. Verifica se a arquitetura de dados do projeto está completa, consistente com as definições de arquitetura e segurança, e cobre armazenamento, pipelines, governança e tecnologias.
...
**Arquivos gerados pelo GENERATE:** `PROJECT-TECHNICAL-DEFINITIONS-DATA-ARCHITECTURE-DEFINITION.md`
...
Ler `PROJECT-TECHNICAL-DEFINITIONS-DATA-ARCHITECTURE-DEFINITION.md`, Architecture Definition (F7), Security Definition (F8), PRD Definition (F4), ADRs globais e data standards.
...
*(Instrução: O processo pausa aqui. Assim que o humano responder, injete este relatório + respostas no PROMPT-FIX-PROJECT-TECHNICAL-DEFINITIONS-DATA-ARCHITECTURE-DEFINITION.md)*
...
- **DOCUMENTO:** `PROJECT-TECHNICAL-DEFINITIONS-DATA-ARCHITECTURE-DEFINITION.md` gerado conforme Architecture Definition, Security Definition e PRD Definition.
