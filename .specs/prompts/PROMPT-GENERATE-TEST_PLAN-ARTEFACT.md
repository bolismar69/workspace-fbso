...
Este prompt orquestra skills especializadas em qualidade de software e estratégia de testes para gerar ou revisar o artefato `TEST_PLAN.md` na pasta de especificações de uma solução técnica.
...
### Passo 3 — Gerar TEST_PLAN.md

Gerar em: `{SOLUTION_PATH}/.specs/business-projects/{PROJECT_NAME}/TEST_PLAN.md`

#### Estrutura Obrigatória

```markdown
# TEST_PLAN.md — Plano de Testes: {SOLUTION_NAME}
