...
Este prompt implementa o **Gate de Viabilidade e Completude Técnica** para o artefato `TECHNICAL-SOLUTION-SPECS.md`, conforme definido no fluxo Spec-Driven Development (etapa 3.1 — GT1).
...
**Princípio fundamental:** O TECHNICAL-SOLUTION-SPECS.md é a ponte entre requisitos e implementação. Uma especificação incompleta ou inconsistente gera tarefas mal definidas, retrabalho e bugs.
...
Ler obrigatoriamente:
    ├── {SOLUTION_PATH}/.specs/business-projects/{PROJECT_NAME}/TECHNICAL-SOLUTION-SPECS.md (artefato a ser validado)
    ├── {SOLUTION_PATH}/.specs/business-projects/{PROJECT_NAME}/TECHNICAL-SOLUTION-PRD.md (baseline de escopo — APROVADO)
    ├── {SOLUTION_PATH}/.specs/business-projects/{PROJECT_NAME}/TECHNICAL-SOLUTION-ARCHITECTURE.md (baseline técnica — APROVADO)
...
Se TECHNICAL-SOLUTION-SPECS.md não existir → ERRO: "TECHNICAL-SOLUTION-SPECS.md não encontrado. Execute o agente gerador de SPECS."
Se TECHNICAL-SOLUTION-PRD.md ou TECHNICAL-SOLUTION-ARCHITECTURE.md não existirem → ERRO: "TECHNICAL-SOLUTION-PRD.md e TECHNICAL-SOLUTION-ARCHITECTURE.md aprovados são pré-requisitos para validação do TECHNICAL-SOLUTION-SPECS.md."
```

### Passo 2 — Executar Dimensões de Validação Técnica

O gate avalia o TECHNICAL-SOLUTION-SPECS.md em **6 dimensões**. Para cada dimensão, atribuir um veredito: `APROVADO`, `RESSALVA` ou `REPROVADO`.

#### Dimensão 1: Rastreabilidade e Cobertura

| # | Verificação | Critério |
|---|---|---|
| 1.1 | Matriz BR → Feature → US | Cada requisito de negócio (BR) está mapeado para uma feature e user story no TECHNICAL-SOLUTION-SPECS.md? |
| 1.2 | Cobertura de features | Todas as features do TECHNICAL-SOLUTION-PRD.md atribuídas a esta solução estão especificadas? |
| 1.3 | Features órfãs | Existem features no TECHNICAL-SOLUTION-SPECS.md sem correspondência no TECHNICAL-SOLUTION-PRD.md? |
...
| # | Verificação | Critério |
|---|---|---|
| 3.1 | Entidades vs modelo de dados | As entidades no §6 do TECHNICAL-SOLUTION-SPECS.md correspondem às entidades do TECHNICAL-SOLUTION-ARCHITECTURE.md? |
| 3.2 | APIs vs estrutura de pacotes | Os endpoints do TECHNICAL-SOLUTION-SPECS.md são suportados pela estrutura de pacotes do TECHNICAL-SOLUTION-ARCHITECTURE.md? |
| 3.3 | NFRs vs ADRs | Os NFRs do TECHNICAL-SOLUTION-SPECS.md são endereçados pelos ADRs do TECHNICAL-SOLUTION-ARCHITECTURE.md? |
...
| 6.4 | Referências cruzadas | Links para TECHNICAL-SOLUTION-PRD.md, TECHNICAL-SOLUTION-ARCHITECTURE.md e docs do projeto estão corretos? |
...
```markdown
# TECHNICAL_SPECS_FAIL_REPORT.md — Relatório de Validação Técnica: TECHNICAL-SOLUTION-SPECS.md

[Header com metadados: solução, tipo, projeto, data, versão do TECHNICAL-SOLUTION-SPECS.md validado]
...
- Bloqueia TECHNICAL-SOLUTION-TASKS.md? SIM (se REPROVADO) | NÃO (se RESSALVA, mas requer acompanhamento)
...
- Itens que IMPEDEM a geração de TECHNICAL-SOLUTION-TASKS.md (não-conformidades críticas)
...
- Seções do TECHNICAL-SOLUTION-SPECS.md que precisam ser reescritas ou complementadas

## 7. Próximos Passos
1. Encaminhar este relatório ao Agente de Specs para correção
2. Após correção, reexecutar este gate
3. Não prosseguir para TECHNICAL-SOLUTION-TASKS.md até TECHNICAL-SOLUTION-SPECS.md ser APROVADO (ou RESSALVA com acompanhamento)
...
| 2 | Sumário executivo | §1 contém veredito e indica se bloqueia TECHNICAL-SOLUTION-TASKS.md |
...
| 4ª | `gap-analysis` | Identificar lacunas entre TECHNICAL-SOLUTION-SPECS.md, TECHNICAL-SOLUTION-PRD.md e TECHNICAL-SOLUTION-ARCHITECTURE.md |
...
1. **Este gate é o ponto de não-retorno técnico.** Após TECHNICAL-SOLUTION-SPECS.md aprovado, o time começa a decompor em tarefas (TECHNICAL-SOLUTION-TASKS.md) e cenários de teste (TECHNICAL-SOLUTION-TEST_PLAN.md). Erros aqui custam caro downstream.
...
4. **Consistência cruzada é obrigatória.** O TECHNICAL-SOLUTION-SPECS.md deve ser consistente com TECHNICAL-SOLUTION-PRD.md (escopo), TECHNICAL-SOLUTION-ARCHITECTURE.md (como) e FEATURES.md (user stories). Inconsistências entre documentos são tratadas como não-conformidades.
...
|:---|:---|:---|:---|
| 1.0 | 13/07/2026 | Criação inicial: gate técnico para TECHNICAL-SOLUTION-SPECS.md, 6 dimensões, 24 verificações, classificação bloqueante vs não-bloqueante | Time de Arquitetura |
