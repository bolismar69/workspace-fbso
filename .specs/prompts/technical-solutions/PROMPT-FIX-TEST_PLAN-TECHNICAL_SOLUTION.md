...
Este prompt é acionado quando o **Gate de Viabilidade e Completude Técnica** (PROMPT-GATE-TEST_PLAN-TECHNICAL) reprova o `TECHNICAL-SOLUTION-TEST_PLAN.md` e gera o relatório `TECHNICAL_TEST_PLAN_FAIL_REPORT.md`.

O agente atua como **corretor de plano de testes** — lê o relatório de falha e aplica correções no TECHNICAL-SOLUTION-TEST_PLAN.md, com foco em **cobertura de features**, **qualidade dos cenários** e **cobertura de segurança**.
...
Ler obrigatoriamente:
    ...
    ├── {SOLUTION_PATH}/.specs/business-projects/{PROJECT_NAME}/TECHNICAL-SOLUTION-TEST_PLAN.md (a corrigir)
    ├── {SOLUTION_PATH}/.specs/business-projects/{PROJECT_NAME}/TECHNICAL-SOLUTION-SPECS.md
    ├── {SOLUTION_PATH}/.specs/business-projects/{PROJECT_NAME}/TECHNICAL-SOLUTION-TASKS.md
...
### Passo 3 — Aplicar Correções no TECHNICAL-SOLUTION-TEST_PLAN.md
...
Para cada NC no relatório:
    ...
    │         → Consultar feature no TECHNICAL-SOLUTION-SPECS.md e 04-FEATURES.md
    ...
    │         → Adicionar ao marco de teste correspondente no TECHNICAL-SOLUTION-TASKS.md
    │
    ├── NC de SEGURANÇA (P0)?
...
Gerar/atualizar tabela de cobertura no próprio TECHNICAL-SOLUTION-TEST_PLAN.md:
...
| 6ª | `documentation-writer` | Qualidade do TECHNICAL-SOLUTION-TEST_PLAN.md corrigido |
...
2. **Segurança não é opcional.** Mesmo que o TECHNICAL-SOLUTION-PRD.md não explicite requisitos de segurança, cenários básicos de RBAC e Multi-Tenant são obrigatórios em toda feature com endpoints.
...
|:---|:---|:---|:---|
| 1.0 | 13/07/2026 | Criação inicial: correção de TECHNICAL-SOLUTION-TEST_PLAN.md baseada em TECHNICAL_TEST_PLAN_FAIL_REPORT.md, foco em cobertura e segurança | Time de Arquitetura |
