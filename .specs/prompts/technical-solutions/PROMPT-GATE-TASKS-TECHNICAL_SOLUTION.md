...
Este prompt implementa o **Gate de Viabilidade e Completude Técnica** para o artefato `TECHNICAL-SOLUTION-TASKS.md`, conforme definido no fluxo Spec-Driven Development (etapa 3.1 — GT2).
...
**Princípio fundamental:** Tarefas mal definidas ou com dependências incorretas geram bloqueios, retrabalho e atrasos. O TECHNICAL-SOLUTION-TASKS.md é o plano de execução — se ele estiver errado, a execução estará errada.
...
Ler obrigatoriamente:
    ├── {SOLUTION_PATH}/.specs/business-projects/{PROJECT_NAME}/TECHNICAL-SOLUTION-TASKS.md (artefato a ser validado)
    ├── {SOLUTION_PATH}/.specs/business-projects/{PROJECT_NAME}/TECHNICAL-SOLUTION-SPECS.md (especificações — APROVADO)
    ├── {SOLUTION_PATH}/.specs/business-projects/{PROJECT_NAME}/TECHNICAL-SOLUTION-PRD.md (escopo — APROVADO)
    ├── {SOLUTION_PATH}/.specs/business-projects/{PROJECT_NAME}/TECHNICAL-SOLUTION-ARCHITECTURE.md (arquitetura — APROVADO)
    └── Documentos de referência:
          ├── {PROJECT_PATH}/01-PROJECT-CHARTER-*.md (marcos M1-M7 e datas)
          └── {PROJECT_PATH}/04-FEATURES.md (features e user stories)

Se TECHNICAL-SOLUTION-TASKS.md não existir → ERRO: "TECHNICAL-SOLUTION-TASKS.md não encontrado."
Se TECHNICAL-SOLUTION-SPECS.md não existir ou não estiver APROVADO → ERRO: "TECHNICAL-SOLUTION-SPECS.md aprovado é pré-requisito."
```

### Passo 2 — Executar Dimensões de Validação Técnica

O gate avalia o TECHNICAL-SOLUTION-TASKS.md em **5 dimensões**. Veredito por dimensão: `APROVADO`, `RESSALVA` ou `REPROVADO`.

#### Dimensão 1: Cobertura e Rastreabilidade

| # | Verificação | Critério |
|---|---|---|
| 1.1 | Cobertura de features | Cada feature do TECHNICAL-SOLUTION-SPECS.md tem tarefas correspondentes no TECHNICAL-SOLUTION-TASKS.md? |
| 1.2 | Cobertura de user stories | Cada user story está coberta por pelo menos uma tarefa? |
| 1.3 | Tarefas órfãs | Existem tarefas sem feature/US correspondente no TECHNICAL-SOLUTION-SPECS.md? |
...
| # | Verificação | Critério |
|---|---|---|
| 3.1 | Dependências documentadas | O §3 do TECHNICAL-SOLUTION-TASKS.md documenta dependências entre tarefas? |
...
| 4.4 | Priorização MoSCoW | A prioridade (Must/Should/Could/Won't) está alinhada com o TECHNICAL-SOLUTION-PRD.md e TECHNICAL-SOLUTION-SPECS.md? |

#### Dimensão 5: Alinhamento com Arquitetura

| # | Verificação | Critério |
|---|---|---|
| 5.1 | Tarefas de infraestrutura | As tarefas refletem a estrutura de pacotes do TECHNICAL-SOLUTION-ARCHITECTURE.md? (ex: tarefa para criar pacote `repository`) |
...
```markdown
# TECHNICAL_TASKS_FAIL_REPORT.md — Relatório de Validação Técnica: TECHNICAL-SOLUTION-TASKS.md

[Header: solução, projeto, data, versão do TECHNICAL-SOLUTION-TASKS.md validado]
...
- Bloqueia TECHNICAL-SOLUTION-TEST_PLAN.md? SIM (se REPROVADO) | NÃO (se RESSALVA)
...
3. Não prosseguir para TECHNICAL-SOLUTION-TEST_PLAN.md até TECHNICAL-SOLUTION-TASKS.md ser APROVADO
...
| 2 | Sumário executivo | §1 contém veredito e indica se bloqueia TECHNICAL-SOLUTION-TEST_PLAN.md |
...
| 3ª | `gap-analysis` | Identificar lacunas de cobertura vs TECHNICAL-SOLUTION-SPECS.md |
...
5. **O TECHNICAL-SOLUTION-TASKS.md evolui com a execução.** O modo `delta` do agente gerador de TASKS deve ser usado para manter o plano atualizado. Este gate deve ser reexecutado sempre que houver alteração significativa no plano.
...
|:---|:---|:---|:---|
| 1.0 | 13/07/2026 | Criação inicial: gate técnico para TECHNICAL-SOLUTION-TASKS.md, 5 dimensões, 20 verificações, foco em granularidade e dependências | Time de Arquitetura |
