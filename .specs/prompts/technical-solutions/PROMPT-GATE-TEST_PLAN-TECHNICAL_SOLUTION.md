...
Este prompt implementa o **Gate de Viabilidade e Completude Técnica** para o artefato `TECHNICAL-SOLUTION-TEST_PLAN.md`, conforme definido no fluxo Spec-Driven Development (etapa 3.1 — GT3).
...
Ler obrigatoriamente:
    ├── {SOLUTION_PATH}/.specs/business-projects/{PROJECT_NAME}/TECHNICAL-SOLUTION-TEST_PLAN.md (artefato a ser validado)
    ├── {SOLUTION_PATH}/.specs/business-projects/{PROJECT_NAME}/TECHNICAL-SOLUTION-SPECS.md (especificações — APROVADO)
    ├── {SOLUTION_PATH}/.specs/business-projects/{PROJECT_NAME}/TECHNICAL-SOLUTION-TASKS.md (tarefas — APROVADO)
    ├── {SOLUTION_PATH}/.specs/business-projects/{PROJECT_NAME}/TECHNICAL-SOLUTION-ARCHITECTURE.md (estratégia de testes — APROVADO)
...
Se TECHNICAL-SOLUTION-TEST_PLAN.md não existir → ERRO: "TECHNICAL-SOLUTION-TEST_PLAN.md não encontrado."
Se TECHNICAL-SOLUTION-SPECS.md ou TECHNICAL-SOLUTION-TASKS.md não estiverem APROVADOS → ERRO: "TECHNICAL-SOLUTION-SPECS.md e TECHNICAL-SOLUTION-TASKS.md aprovados são pré-requisitos."
```

### Passo 2 — Executar Dimensões de Validação Técnica

O gate avalia o TECHNICAL-SOLUTION-TEST_PLAN.md em **6 dimensões**. Veredito por dimensão: `APROVADO`, `RESSALVA` ou `REPROVADO`.

#### Dimensão 1: Cobertura de Features e User Stories

| # | Verificação | Critério |
|---|---|---|
| 1.1 | Feature coverage | Cada feature do TECHNICAL-SOLUTION-SPECS.md tem cenários de teste no TECHNICAL-SOLUTION-TEST_PLAN.md? |
| 1.2 | User story coverage | Cada user story tem pelo menos 1 cenário de teste? |
| 1.3 | Cenários órfãos | Existem cenários de teste para features/US não existentes no TECHNICAL-SOLUTION-SPECS.md? |
| 1.4 | Cobertura de regras de negócio | Cada RN do TECHNICAL-SOLUTION-SPECS.md tem cenários de teste que validam casos de borda? |
...
```markdown
# TECHNICAL_TEST_PLAN_FAIL_REPORT.md — Relatório de Validação Técnica: TECHNICAL-SOLUTION-TEST_PLAN.md

[Header: solução, stack, projeto, data, versão do TECHNICAL-SOLUTION-TEST_PLAN.md validado]
...
3. Não prosseguir para DESENVOLVIMENTO até TECHNICAL-SOLUTION-TEST_PLAN.md ser APROVADO
...
| 4ª | `gap-analysis` | Identificar lacunas de cobertura vs TECHNICAL-SOLUTION-SPECS.md |
...
1. **Último gate antes do desenvolvimento.** O TECHNICAL-SOLUTION-TEST_PLAN.md é o último artefato validado antes do time começar a codificar. Um plano de testes fraco resulta em bugs escapando para produção.
...
4. **Cenários órfãos indicam desalinhamento.** Cenários de teste para features inexistentes sugerem que o TECHNICAL-SOLUTION-TEST_PLAN.md foi gerado a partir de um TECHNICAL-SOLUTION-SPECS.md desatualizado.

5. **Reexecução após correção.** Assim como os outros gates, este gate deve ser reexecutado após cada ciclo de correção do TECHNICAL-SOLUTION-TEST_PLAN.md.
...
|:---|:---|:---|:---|
| 1.0 | 13/07/2026 | Criação inicial: gate técnico para TECHNICAL-SOLUTION-TEST_PLAN.md, 6 dimensões, 25 verificações, mapa de cobertura Feature × Cenários | Time de Arquitetura |
