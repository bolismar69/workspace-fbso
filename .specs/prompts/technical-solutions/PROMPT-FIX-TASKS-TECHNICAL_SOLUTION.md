...
Este prompt é acionado quando o **Gate de Viabilidade e Completude Técnica** (PROMPT-GATE-TASKS-TECHNICAL) reprova o `TECHNICAL-SOLUTION-TASKS.md` e gera o relatório `TECHNICAL_TASKS_FAIL_REPORT.md`.

O agente atua como **corretor de planejamento** — lê o relatório de falha e aplica correções no TECHNICAL-SOLUTION-TASKS.md, com foco em **granularidade** (decompor tarefas grandes), **dependências** (resolver ciclos e lacunas) e **cobertura** (garantir que toda feature/US tem tarefas).
...
Ler obrigatoriamente:
    ...
    ├── {SOLUTION_PATH}/.specs/business-projects/{PROJECT_NAME}/TECHNICAL-SOLUTION-TASKS.md (a corrigir)
...
### Passo 3 — Aplicar Correções no TECHNICAL-SOLUTION-TASKS.md
...
Para cada NC no relatório:
    ...
    │     → Atualizar §3 (Dependências) do TECHNICAL-SOLUTION-TASKS.md
    │
    ├── NC de COBERTURA (P0)?
    │     → Feature/US sem tarefas → consultar TECHNICAL-SOLUTION-SPECS.md para entender escopo
...
| 2 | Cobertura completa | Toda feature/US do TECHNICAL-SOLUTION-SPECS.md tem tarefas |
...
| 4ª | `documentation-writer` | Qualidade do TECHNICAL-SOLUTION-TASKS.md corrigido |
...
3. **Criar tarefas seguindo a estrutura do TECHNICAL-SOLUTION-ARCHITECTURE.md.** Para features sem cobertura, criar tarefas que sigam a estrutura de pacotes documentada: modelo → repositório → serviço → controller → testes.
...
|:---|:---|:---|:---|
| 1.0 | 13/07/2026 | Criação inicial: correção de TECHNICAL-SOLUTION-TASKS.md baseada em TECHNICAL_TASKS_FAIL_REPORT.md, foco em decomposição e resolução de dependências | Time de Arquitetura |
