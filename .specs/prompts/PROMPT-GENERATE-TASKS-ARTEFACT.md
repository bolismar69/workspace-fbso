...
Este prompt orquestra skills especializadas em planejamento de tarefas e gestão de backlog para gerar ou revisar o artefato `TASKS.md` na pasta de especificações de uma solução técnica.
...
Verificar se existe: {SOLUTION_PATH}/.specs/business-projects/{PROJECT_NAME}/
    ...
    └── SIM, existe →
            │
            ├── Verificar se existem PRD.md, SPECS.md E ARCHITECTURE.md
            ...
            │
            └── Verificar se TASKS.md já existe:
...
Gerar em: `{SOLUTION_PATH}/.specs/business-projects/{PROJECT_NAME}/TASKS.md`
