# PROMPT-GENERATE-SOURCING-FACTORY-BIDDING-RFQ-PACKAGE

## Contexto

Este prompt implementa o **GENERATE do RFQ-PACKAGE** para o processo de Sourcing & Factory Bidding (Fase 1).
...
🤖 *Sourcing & Factory Bidding — Fase 1 GENERATE*
